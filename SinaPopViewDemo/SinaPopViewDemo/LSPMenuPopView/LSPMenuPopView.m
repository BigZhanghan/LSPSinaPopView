...
+ (void)showMoreWithTitle:(NSArray *)titleArray
    ...
    LSPMenuPopView *modeView = [[LSPMenuPopView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
